...
export const MapPins: Record<string, { mapId: number; x: number; y: number }> = {
  I2教室: { mapId: 0, x: 950, y: 70 },
  K2教室: { mapId: 0, x: 1030, y: 70 },
  S2教室: { mapId: 0, x: 1110, y: 70 },
  I3教室: { mapId: 1, x: 910, y: 250 },
  K3教室: { mapId: 1, x: 990, y: 250 },
  S3教室: { mapId: 1, x: 1070, y: 250 },
  K4教室: { mapId: 2, x: 550, y: 500 },
  S4教室: { mapId: 2, x: 600, y: 500 },
  I5教室: { mapId: 0, x: 700, y: 70 },
  第2プラザ: { mapId: 0, x: 850, y: 70 },
  第1体育館: { mapId: 4, x: 400, y: 450 },
  ラウンジA: { mapId: 0, x: 500, y: 500 },
  ラウンジB: { mapId: 1, x: 500, y: 500 },
  ラウンジC: { mapId: 2, x: 500, y: 500 },
  学生昇降口: { mapId: 0, x: 500, y: 500 },
  図書館: { mapId: 5, x: 500, y: 500 },
  なごうら: { mapId: 6, x: 500, y: 500 },
  電子情報第1実験室: { mapId: 1, x: 500, y: 500 },
  K4紹介: { mapId: 8, x: 500, y: 500 },
  K5紹介: { mapId: 8, x: 500, y: 500 },
  "航海学演習室・公開計測演習室・レーダーシミュレーター演習室": { mapId: 8, x: 500, y: 500 },
  ものづくり教室: { mapId: 0, x: 600, y: 500 },
  共通講義室1: { mapId: 0, x: 750, y: 300 },
  奈呉の浦会館2F和室: { mapId: 6, x: 300, y: 300 },
};

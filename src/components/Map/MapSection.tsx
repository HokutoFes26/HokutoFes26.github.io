...
import { mapList, MapPins } from "@/components/Map/MapPins";
...
export default function MapSection({ initialPlace }: { initialPlace?: string | null }) {
    ...
    return (
        <div className="pr-map-section mapCard">
            <div className="webapp-map-wrapper">
                ...
                <div ref={containerRef} className="maps-container" style={{ height: "500px", position: "relative" }}>
                    {L && isReady ? (
                        <MapContainer
